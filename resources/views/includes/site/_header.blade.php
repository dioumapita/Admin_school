...
<header class="header_area header_padding">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="top_right text-right">
                            <ul>
                                ...
                                {{-- <li class="language"><a href="#"><img src="/assets/asset_site/img/logo/language.png" alt="">en-gb<i class="ion-ios-arrow-down"></i></a>
                                    <ul class="dropdown_language">
                                        <li><a href="#"><img src="/assets/asset_site/img/logo/language.png" alt=""> English</a></li>
                                        <li><a href="#"><img src="/assets/asset_site/img/logo/language2.png" alt=""> Germany</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="middel_right">
                        <div class="search-container">
                            <form action="#">
                                <div class="search_box">
                                    <input placeholder="Cherchez ..." type="text">
                        ...
                        <div class="middel_right_info">
                            ...
                            <div class="header_wishlist">
                                <a href="wishlist.html"><span class="fa fa-facebook"></span> facebook </a>
                            </div>
                            <div class="mini_cart_wrapper">
                                <a href="javascript:void(0)"><span class="fa fa-twitter"></span>Twitter </a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="mini_cart">
        ...
        <div class="cart_item">
            <div class="cart_img">
                <a href="#"><img src="/assets/asset_site/img/s-product/product.jpg" alt=""></a>
            </div>
            <div class="cart_info">
        ...
        <div class="cart_item">
            <div class="cart_img">
                <a href="#"><img src="/assets/asset_site/img/s-product/product2.jpg" alt=""></a>
            </div>
            <div class="cart_info">
                ...
                <div class="col-12">
                    <div class="header_bottom_container">
                                        ...
                                        <ul class="categories_mega_menu">
                                            ...
                                            <li class="menu_item_children last_child"><a href="#">Wheel Simulators</a>
                                                ...
                                                <div class="categorie_banner">
                                                    <a href="#"><img src="/assets/asset_site/img/bg/banner2.jpg" alt=""></a>
                                                </div>
                                            </li>
                        ...
                        <div class="main_menu">
                            <nav>
                                <ul>
                                    {{-- <li><a href="index.html">h<i class="fa fa-angle-down"></i></a>
                                        <ul class="sub_menu">
                                    ...
                                    {{-- <li class="mega_items"><a href="shop.html">shop<i class="fa fa-angle-down"></i></a>
                                        <div class="mega_menu">
                                            ...
                                            <div class="banner_static_menu">
                                                <a href="shop.html"><img src="/assets/asset_site/img/bg/banner1.jpg" alt=""></a>
                                            </div>
                                        </div>
                                    </li> --}}
