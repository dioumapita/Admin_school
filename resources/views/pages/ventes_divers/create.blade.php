{{-- on herite du chemin du theme actif --}}
    @extends($chemin_theme_actif,['title' => 'Vente-Divers'])
        @section('content')
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Vente Des Divers</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Vente Des Divers</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-topline-red">
                        <div class="card-head">
                            <header>Vente Des Divers</header>
                            <div class="tools">
                                    ...
                                    <tbody>
                                        @foreach ($all_divers as $divers)
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="">
                                                    <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#nouveau{{$divers->id}}">Effectuer Une Vente
                                                        <i class="fa fa-plus"></i>
                                                    </button>
                                                    <!-- debut modal -->
                                                        <div class="modal fade" data-backdrop="static" id="nouveau{{$divers->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                            aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <!-- start modal body -->
                                                                        <div class="modal-body">
                                                                            <form action="{{ route('vente_divers.store') }}" method="post">
                                                                                {{ csrf_field() }}
                                                                                <input type="hidden" name="divers_id" value="{{ $divers->id }}">
