            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form method="POST" action="{{ route('fournisseur.store') }}"  class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-body">
                                <!--Start Nom -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="ville" placeholder="Entrez la ville"
                                                value="{{ old('ville') }}" class="form-control @error('ville')is-invalid @enderror" required/>
                                            @error('ville')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong id="msg_error_profil">{{ $message }}</strong>
                                                    </span>
                                ...
                                <!-- Start Image -->
                                    <div class="form-group row">
                                      <label class="control-label col-md-3" for="">Photo</label>
                                        <div class="col-md-5">
                                            <input type="file" class="form-control-file" name="photo_fournisseur" id="photo_fournisseur" placeholder="Choisir une image" aria-describedby="fileHelpId">
                                        </div>
                                    </div>
                                <!-- end Image -->
