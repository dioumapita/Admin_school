    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                <div class="card-head">
                    <header>Ajouter Une Matière</header>
                        ...
                        <div class="form-body">
                            <!--Start Nom Matière -->
                                <div class="form-group row">
                                    <label for="nom_matiere" class="control-label col-md-3">Nom Matière
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-5">
                                        <input type="text" name="nom_matiere" id="nom_matiere" placeholder="Entrez une matière (Exemple: Biologie)"
                                            value="{{ old('nom_matiere') }}" class="form-control @error('nom_matiere')is-invalid @enderror" />
                                           @error('nom_matiere')
                            ...
                            <!-- Start Classe -->
                                <div class="form-group row">
                                    <label for="niveau" class="control-label col-md-3">Classe
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-5">
                                        <select id="niveau" name="niveau[]" class="form-control select2-multiple @error('niveau')is-invalid @enderror" multiple>
                            ...
                            <!-- Start Coéfficient -->
                                <div class="form-group row">
                                    <label for="coefficient" class="control-label col-md-3">Coéfficient
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-5">
                                        ...
                                        <span class="help-block">Valeur maximum: 4</span>
                                    </div>
                                </div>
                            <!-- End Coéfficient -->
                                ...
                                <div class="center form-actions">
                                    <div class="row">
                                        <div class="offset-md-3 col-md-8">
                                            ...
                                            {{-- <a href="{{ route('config_matiere_get') }}" class="btn btn-warning">
                                                Config Matiere
                                            </a> --}}
                                        </div>
                                    </div>
