        ...
        @section('content')
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Modification Des Elèves</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Modification Des Elèves</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        <div class="card-head">
                            <header>Inscriptions Des Elèves</header>
                        </div>
                        <div class="card-body ">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-height"
                                                            name="date_naissance" id="date_naissance" value="{{ $eleve->date_naissance }}"
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control input-height" name="classe">
                                                            ...
                                                            @foreach ($all_classes as $classe)
                                                                <option value="{{ $classe->id }}" @if($classe->id == $test->niveau->id) selected @endif>{{ $classe->nom_niveau.' '.$classe->options }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-12 p-t-20">
                                        <!-- Start Année Scolaire -->
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        <select class="form-control input-height" name="annee">
                                                            <option value="">Selectionner...</option>
                                                            @foreach ($all_annees as $annee)
                                                                <option value="{{ $annee->id }}" @if($annee->id == $test->annee->id) selected  @endif>{{ $annee->annee_scolaire}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
