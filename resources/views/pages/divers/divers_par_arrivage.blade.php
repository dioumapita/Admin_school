@extends($chemin_theme_actif,['title' => 'Divers-Liste'])
    @section('content')
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Liste Des Divers Par Arrivage</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Liste Des Divers Par Arrivage</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-red">
                    <div class="card-head">
                        <header>Liste Des Divers Par Arrivage</header>
                        <div class="tools">
                    ...
                    <div class="card-body ">
                            ...
                            <div class="col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div  class="modal-header btn btn-danger text-center text-white">
                                                    <h4 class="modal-title white-text w-100 font-weight-bold py-2">Enregistrer Un Diver</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('divers.store') }}" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="nom_divers">Nom Du Diver</label>
                                                                <input type="text" name="nom_divers" id="nom_divers" class="form-control" value="{{ old('nom_divers') }}" placeholder="Entrez le nom du diver" required>
                                                            </div>
                                                            <div class="form-group">
                                ...
                                <div class="btn-group">
                                    <button id="addRow1" data-toggle="modal" data-target="#all_niveau" class="btn btn-primary">
                                        <i class="fa fa-list"></i> Afficher Les Divers Par Arrivage
                                    </button>
                                </div>
                                <!-- debut modal -->
                                                ...
                                                <!-- start modal body -->
                                                    <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <option value=""></option>
                                                                @foreach ($all_arrivages as $arrivage)
                                                                    <option value="{{ route('divers_par_arrivage',$arrivage->id) }}">{{ $arrivage->nom_arrivage}}</option>
                                                                @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="modal-footer d-flex justify-content-center">
                        ...
                        <div class="table-scrollable">
                            <table
                                ...
                                <tbody>
                                    @foreach ($all_divers as $divers)
                                        <tr class="odd gradeX">
                                            <td class="text-center">{{ $i++ }}</td>
                                            <td class="text-center">{{ $divers->nom_divers }}</td>
                                            <td class="text-center">{{ $divers->prix.' GNF' }}</td>
                                            <td class="text-center">{{ $divers->quantite }}</td>
                                            <td>
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#classes{{ $divers->id }}">Modifier
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                                <!-- debut modal -->
                                                    <div class="modal fade" data-backdrop="static" id="classes{{ $divers->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div  class="modal-header btn btn-danger text-center text-white">
                                                                ...
                                                                <!-- start modal body -->
                                                                    <div class="modal-body">
                                                                        <form action="{{ route('divers.update',$divers->id) }}" method="post" enctype="multipart/form-data">
                                                                            {{ csrf_field() }}
                                                                            {{ method_field('PUT') }}
                                                                            <div class="form-group">
                                                                                <label for="nom_divers">Nom Du Divers</label>
                                                                                <input type="text" name="nom_divers" id="nom_divers" class="form-control" value="{{ $divers->nom_divers }}" placeholder="Entrez le nom du divers" required>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="prix">Prix</label>
                                                                                <input type="text" name="prix" id="prix" class="form-control" value="{{ $divers->prix }}" placeholder="Entrez le prix" required>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="quantite">Quantité</label>
                                                                                <input type="text" name="quantite" id="quantite" class="form-control" value="{{ $divers->quantite }}" placeholder="Entrez la quantite" required>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="voiture_id">Arrivage</label>
                                                                                    <select class="form-control" name="arrivage_id" id="arrivage_id">
                                                                                        <option value="">Sélectionnez un arrivage</option>
                                                                                        @foreach ($all_arrivages as $arrivage)
                                                                                            <option value="{{ $arrivage->id }}" @if($arrivage->id == $divers->arrivage_id) selected @endif>{{ $arrivage->nom_arrivage }}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                            </div>
                                                                            <div class="modal-footer d-flex justify-content-center">
                                                ...
                                                <!-- fin modal -->
                                                <a href="#myModal" data-toggle="modal" onclick="deleteData({{ $divers->id }})"
                                                    ...
                                                    <div class="mt-5 modal-dialog modal-confirm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer justify-content-center">
                                                                ...
                                                                <form action="{{ route('divers.destroy',$divers->id) }}" method="post" id="deleteform">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('DELETE') }}
                        ...
                        <div class="col-md-12">
                                    ...
                                    <div class="cercle">
                                        <div class="text-center">
                                            <h4 class="font-bold addr-font-h4">
                                                <u class="souligner">Liste De Tous Les Divers</u><br>
                            ...
                            <div>
                                <table id="bordure_table" class="table table-bordered">
                                    ...
                                    <th class="text-center" id="bordure_table"> Diver </th>
                                    ...
                                    <tbody id="bordure_table">
                                        @foreach ($all_divers as $divers)
                                            <tr id="bordure_table">
                                                ...
                                                <td class="text-center" id="bordure_table">{{ $divers->nom_divers }}</td>
                                                <td class="text-center" id="bordure_table">{{ $divers->prix }}</td>
                                                <td class="text-center" id="bordure_table">{{ $divers->quantite }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
    ...
    <script>
        function deleteData(id)
             {
                 var id = id;
                 var url = '{{ route("divers.destroy", ":id") }}';
