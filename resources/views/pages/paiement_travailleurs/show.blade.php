...
@section('content')
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">Historique De Paiement</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="active">Historique De Paiement</li>
            </ol>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    <div class="card-head">
                                        <header>Historique De Paiement De {{ $infos->travailleur->nom.' '.$infos->travailleur->prenom }}</header>
                                        <div class="tools">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <div class="table-scrollable">
                                            <table
                                                ...
                                                <tbody>
                                                    @foreach ($historiques_paiements as $historique)
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-center">{{ $historique->montant_payer }}</td>
                                                                ...
                                                                <!-- debut modal -->
                                                                    <div class="modal fade" data-backdrop="static" id="classes{{ $historique->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                                        ...
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div  class="modal-header btn btn-danger text-center text-white">
                                                                                    <h4 class="modal-title white-text w-100 font-weight-bold py-2">Modification D'un Paiement</h4>
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true" class="white-text">&times;</span>
                                                                                    </button>
                                                                                </div>
                                                                                <!-- start modal body -->
                                                                                    <div class="modal-body">
                                                                                        <form action="{{ route('paiement_travailleur.update',$historique->id) }}" method="post">
                                                                                            {{ csrf_field() }}
                                                                                            {{ method_field('PUT')}}
                                                                                            <div class="form-group">
                                                                                                <label for="montant_payer">Montant Payé</label>
                                                                                                <input type="number" name="montant_payer" id="montant_payer" min="0" class="form-control" value="{{ $historique->montant_payer }}" placeholder="montant payer" required>
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="mt-5 modal-dialog modal-confirm">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer justify-content-center">
                                                                                ...
                                                                                <form action="{{ route('paiement_travailleur.destroy',$historique->id) }}" method="post" id="deleteform">
                                                                                    {{ csrf_field() }}
                                                                                    {{ method_field('DELETE') }}
...
<script>
    function deleteData(id)
            {
                var id = id;
                var url = '{{ route("paiement_travailleur.destroy", ":id") }}';
