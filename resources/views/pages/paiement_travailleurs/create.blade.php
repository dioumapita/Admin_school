@extends($chemin_theme_actif,['title' => 'Paiement-Travailleur'])
    @section('content')
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Paiement Des Travailleurs</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Paiement Des Travailleurs</li>
                </ol>
            </div>
        </div>
        <div class="row">
                                                    ...
                                                    <tbody>
                                                        @foreach ($all_travailleurs as $travailleur)
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-primary" data-toggle="modal" data-target="#classes{{ $travailleur->id }}">Effectuez un paiement
                                                                    ...
                                                                    <!-- debut modal -->
                                                                        <div class="modal fade" data-backdrop="static" id="classes{{ $travailleur->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    <div  class="modal-header btn btn-danger text-center text-white">
                                                                                        <h4 class="modal-title white-text w-100 font-weight-bold py-2">Paiement D'un Travailleur</h4>
                                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                        <span aria-hidden="true" class="white-text">&times;</span>
                                                                                        </button>
                                                                                    </div>
                                                                                    <!-- start modal body -->
                                                                                        <div class="modal-body">
                                                                                            <form action="{{ route('paiement_travailleur.store') }}" method="post">
                                                                                                {{ csrf_field() }}
                                                                                                <input type="hidden" name="travailleur_id" value="{{ $travailleur->id }}">
                                                                                                <div class="form-group">
                                                                                                    <label for="montant_payer">Montant Payé</label>
                                                                                                    <input type="number" name="montant_payer" id="montant_payer" class="form-control" min="0" placeholder="montant payer" required>
                                                                                                </div>
                                                                                                <div class="form-group">
                                                                    ...
                                                                    <!-- fin modal -->
                                                                    <a href="{{ route('paiement_travailleur.show',$travailleur->id) }}" class="btn btn-danger"><i class="fa fa-recycle" aria-hidden="true"></i> Historique Des Paiements</a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
