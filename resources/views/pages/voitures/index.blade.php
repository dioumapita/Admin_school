...
@section('content')
    ...
    <div id="media_screen" class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">Liste Des Voitures</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="active">Liste Des Voitures</li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-topline-red">
                                    <div class="card-head">
                                        <header>Liste Des Voitures</header>
                                        <div class="tools">
                                    ...
                                    <div class="card-body ">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-6">
                                                ...
                                                <!-- fin modal -->
                                                <a onclick="printDiv('liste_voiture')" href="#" class="btn btn-primary"><i class="fa fa-print"></i> Imprimer </a>
                                                <div class="btn-group">
                                                                                ...
                                                                                <!-- start modal body -->
                                                                                    <div class="modal-body">
                                                                                        <form action="{{ route('voiture.update',$voiture->id) }}" method="post" enctype="multipart/form-data">
                                                                                            ...
                                                                                            {{ method_field('PUT') }}
                                                                                            <div class="form-group">
                                                                                                <label for="immatriculation">N° châssi</label>
                            ...
                            <div class="mx-auto col-md-12 col-sm-12 col-lg-12">
                                <div class="cercles">
                                    <div class="text-center">
                                        <h1 class="font-bold">
                                            <i class="souligner">Liste De Toutes Les Voitures</i>
                                        </h1>
                                    </div>
                                </div>
                            </div>
