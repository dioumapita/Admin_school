...
@section('content')
    ...
    <div id="media_screen" class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">Commande Client</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                        href="{{ route('home') }}">Accueil</a>&nbsp;<i class="fa fa-angle-right"></i>
                </li>
                <li><a class="parent-item" href="#">Commande</a>&nbsp;<i class="fa fa-angle-right"></i>
                </li>
                    ...
                    <div class="row">
                        <div class="card">
                            ...
                            <div class="white-box">
                                ...
                                <div class="container">
                                    <a href="{{ route('client_achat_voiture',$client->id) }}">toto</a>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <!-- start modal body -->
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <form action="{{ route('validation_commande') }}" method="post">
                                                                {{ csrf_field() }}
                                                                <input type="hidden" name="client_id" value="{{ $client->id }}">
                                                                <div class="form-group">
                                                                    <label for="montant_payer">Montant Payé*</label>
                                                                    <input type="number" name="montant_payer" id="montant_payer" max="{{ $total_achat_article + $total_achat_voiture}}" class="form-control" placeholder="Entrez le montant" required>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" name="delais_paiement" id="delais_paiement" class="form-control" placeholder="Entrez le délais">
                                                                </div>
                                                                <div class="modal-footer d-flex justify-content-center">
                                                                    <button type="submit" class="btn btn-primary" >Valider <i class="fa fa-check"></i></button>
                                                                    &nbsp;&nbsp;
                                    ...
                                    <a href="#annulation" data-toggle="modal" onclick="annulationTotale({{ $client->id }})"
                                        ...
                                        <i class="fa fa-trash"></i> Annuler Tout
                                    </a>
                    ...
                    <!-- start modal body -->
                        <div class="modal-body">
                            <form action="{{ route('commande.store') }}" method="post">
                                ...
                                <input type="hidden" name="client_id" value="{{ $client->id }}">
                                <div class="form-group">
                                    <label for="nom_article">Pièce*</label>
    ...
    {{-- <form method="post" action="#" id="printJS-form">
     ...
     <button type="button" onclick="printJS({
		...
		type: 'html',
        targetStyle: ['padding-top', 'border-bottom','margin-top','margin-bottom'],
		style: '.souligner{border-bottom: 5px;border-solid: 5px;}'
     })">
        Print Form
     </button>
@endsection
...
<script>
    //utiliser pour la l'annulation d'une commande
    ...
    //utiliser pour l'annulation de toutes les comandes
