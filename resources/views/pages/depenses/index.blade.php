@extends($chemin_theme_actif,['title' => 'Depenses-Liste'])
    @section('content')
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Liste Des Dépenses</div>
                </div>
                                    ...
                                    <div class="cercle">
                                        <div class="text-center">
                                            <h4 class="font-bold addr-font-h4">
                                                <u class="souligner">Liste Des Toute Les</u><br>
                                                <u class="souligner">Dépenses</u>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
