...
<style>
    ...
    <div id="media_screen" class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">Liste Des Pièces Par Arrivage</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="active">Liste Des Pièces Par Arrivage</li>
            </ol>
        </div>
    </div>
    <div id="media_screen" class="row">
        <div class="col-md-12">
            <div class="card card-topline-red">
                <div class="card-head">
                    <header>Liste Des Pièces Par Arrivage</header>
                    <div class="tools">
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-6">
                            ...
                            <!-- fin modal -->
                            <a onclick="printDiv('liste_piece')" href="#" class="btn btn-primary"><i class="fa fa-print"></i> Imprimerie </a>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="voiture_id">Voiture</label>
                                                                                <select class="form-control" name="voiture_id" id="voiture_id">
                                                                                    <option value="">Sélectionnez une voiture</option>
                                                                                    @foreach ($all_voitures as $voiture)
                                                                                        <option value="{{ $voiture->id }}" @if($voiture->id == $piece->voiture_id) selected @endif>{{ $voiture->nom_voiture }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        </div>
                                                                        <div class="form-group">
                                ...
                                <div class="cercle">
                                    <div class="text-center">
                                        <h4 class="font-bold addr-font-h4">
                                            <u class="souligner">Liste De Toute Les Pièces Achetées</u><br>
